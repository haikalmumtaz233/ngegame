...
<head>
    ...
    <title>Ngegame - Top Up Valorant</title>
    <link rel="stylesheet" href="src/valo.css">
...
<body class="mx-auto">
    ...
    <main>
        <div id="home" class="container">
            <img id="background" src="assets/valorant_banner2.jpeg" alt="background">
            <div class="home-content">
                <br>
                <img src="assets/valorant_logo.png" alt="" width="120px" class="rounded-circle"> <span class="text-white fw-bold fs-2 border-bottom border-danger" style="font-family: 'Inter'; letter-spacing: 2px;">Top Up Valorant</span>
            </div>
            <div id="home-form" class="row justify-content-center mt-3">
                ...
                <div class="col-5">
                    <div class="card text-white" style="background-color: rgba(0, 0, 0, 0.5);">
                        <div class="card-body">
                            <form action="valo_proses.php" method="POST">
                                <div class="mb-3">
                                    <label for="id" class="form-label" style="font-family: 'Montserrat'; font-size: 18px;">1. Masukkan Game ID Valorant Anda</label>
                                ...
                                <div class="mb-3">
                                    <label for="nominal" class="form-label" style="font-family: 'Montserrat'; font-size: 18px;">2. Pilih Jumlah Points Yang Ingin Anda Beli</label>
                                    ...
                                    <select class="form-select bg-dark text-white" aria-label="Default select example" id="nominal" name="nominal">
                                        <option selected>Pilih Points</option>
                                        <?php
                                        include 'connect.php';
                                        ...
                                        ?>
                                            <option value="<?= $data['id_points'] ?>"><?= $data['jumlah'] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="mb-3">
